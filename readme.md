...
"logstash", "airFlake" , "직접 자바로 작성" 의 세가지 선택지 중에서 자바로 작성하기로 했습니다

</br>

- [ ] logstash : 문서가 어려움, 테이블이 많아서 실제 작업량이 줄어드는 느낌이 아님 .
- [ ] snowflake : 레퍼런스 부족
- [x] 직접 자바 코드로 작성  :  cdr_library 보유, 양쪽 다 로직 부분만 짜면 됨 .

Migration 프로젝트 코드는 ./Migration에 작성
